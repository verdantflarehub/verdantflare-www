export const modelMarketCopy = {
  zh: {
    ...
    creating: "创建中...",
    newKey: "新建 API-KEY",
    copyExampleTitle: "复制以下调用示例，发送给任意 AI 助手",
    videoCopyExampleTitle: "复制以下创建与查询示例，在服务端提交视频任务",
    videoTestTitle: "直接测试视频接口",
    videoTestLead:
      "输入已开通模型权限的 API Key，即可创建任务并在当前页面查询结果。API Key 仅保留在本页内存中。",
    testKey: "API Key",
    testKeyPlaceholder: "粘贴 VerdantFlare API Key",
    testPrompt: "提示词",
    testPromptPlaceholder:
      "例如：一位舞者在霓虹舞台完成节奏鲜明的街舞，镜头稳定跟拍，动作自然连贯。",
    testDuration: "时长（1-15 秒）",
    testRatio: "画幅",
    testGenerateAudio: "生成音频",
    testWatermark: "添加水印",
    testImageUrl: "参考图片 HTTPS URL",
    testVideoUrl: "参考视频 HTTPS URL",
    testAudioUrl: "参考音频 HTTPS URL",
    optional: "可选",
    testCreate: "创建视频任务",
    testCreating: "创建中...",
    testClear: "清空结果",
    testNotice:
      "参考素材必须使用服务端可访问的公网 HTTPS URL。此页面不会上传文件，也不会保存 API Key。",
    testTaskTracking: "任务跟踪",
    testTaskId: "任务 ID",
    testStatus: "状态",
    testIdle: "未开始",
    testProgress: "生成进度",
    ...
    testInterval: "间隔（秒）",
    testStop: "停止轮询",
    testOpenResult: "打开生成结果",
    testResponse: "接口响应",
    testResponseWaiting: "等待请求...",
    testCopyResponse: "复制响应",
    testLog: "请求记录",
    testLogWaiting: "等待开始测试",
    testErrorMissingKey: "请输入 API Key。",
    testErrorMissingPrompt: "请输入提示词。",
    testErrorDuration: "时长必须是 1-15 之间的整数。",
    testErrorInvalidUrl: " 不是有效 URL。",
    testErrorHttpsUrl: " 必须使用 HTTPS。",
    testErrorNetwork:
      "浏览器无法访问 API。请检查网络、API Key 权限或服务端的跨域配置。",
    testRequestFailed: "请求失败",
    testErrorNoTaskId: "创建响应没有返回任务 ID。",
    testQueryingTask: "查询任务",
    testQueryFailed: "查询失败：",
    testSubmittingTask: "提交视频创建请求",
    testCreated: "任务已创建：",
    testCreateFailed: "创建失败：",
    testCompleted: "任务完成，已获取结果地址。",
    testCopyFailed: "浏览器拒绝访问剪贴板，请手动复制响应。",
    ...
    cancel: "取消",
    confirm: "确定",
    keyNameError: "请填写 1-20 个字符的 API-KEY 名称。",
    requestFailed: "请求失败",
    keyCreatedMissing: "API-KEY 已创建，但未能在列表中定位到新密钥",
    keyFetchFailed: "API-KEY 已创建，但获取密钥内容失败",
    keyCreated: "API-KEY 已创建，请立即复制并妥善保存。",
  ...
  en: {
    ...
    grid: "Grid",
    list: "List",
    quickFilter: "Capability quick filters",
    all: "All",
    allCapabilities: "All Capabilities",
    allProviders: "All Providers",
    input: "Input",
    output: "Output",
    pointsPerMillion: "credits / million tokens",
    ...
    cacheHit: "Cache hit",
    detailsTabs: "Model detail tabs",
    introTab: "Model Introduction",
    limits: "Model Limits",
    ...
    videoCallTitle: "Method 1: Create a video generation task",
    videoCallLead:
      "verdantflare Dance-2.0 uses an asynchronous video API. Create a task, query the returned task ID, then read the video URL after completion.",
    guide: "Call Guide",
    ...
    copyExampleTitle: "Copy this example and send it to any AI assistant",
    videoCopyExampleTitle: "Copy this create-and-poll example to submit a video task from your service",
    videoTestTitle: "Test the video API directly",
    videoTestLead:
      "Enter an API key with model access to create and query a task on this page. The key remains only in page memory.",
    testKey: "API Key",
    testKeyPlaceholder: "Paste your VerdantFlare API key",
    testPrompt: "Prompt",
    testPromptPlaceholder:
      "For example: A dancer performs a rhythmic street dance on a neon stage, with stable tracking and natural motion.",
    testDuration: "Duration (1-15 seconds)",
    testRatio: "Aspect ratio",
    testGenerateAudio: "Generate audio",
    testWatermark: "Add watermark",
    testImageUrl: "Reference image HTTPS URL",
    testVideoUrl: "Reference video HTTPS URL",
    testAudioUrl: "Reference audio HTTPS URL",
    optional: "Optional",
    testCreate: "Create video task",
    testCreating: "Creating...",
    testClear: "Clear results",
    testNotice:
      "Reference media must use a public HTTPS URL accessible to the service. This page does not upload files or save API keys.",
    testTaskTracking: "Task tracking",
    testTaskId: "Task ID",
    testStatus: "Status",
    testIdle: "Not started",
    testProgress: "Generation progress",
    testQuery: "Query task",
    testQuerying: "Querying...",
    testAutoPoll: "Auto poll",
    testInterval: "Interval (seconds)",
    testStop: "Stop polling",
    testOpenResult: "Open result",
    testResponse: "API response",
    testResponseWaiting: "Waiting for a request...",
    testCopyResponse: "Copy response",
    testLog: "Request log",
    testLogWaiting: "Waiting to start a test",
    testErrorMissingKey: "Enter an API key.",
    testErrorMissingPrompt: "Enter a prompt.",
    testErrorDuration: "Duration must be an integer between 1 and 15.",
    testErrorInvalidUrl: " is not a valid URL.",
    testErrorHttpsUrl: " must use HTTPS.",
    testErrorNetwork:
      "The browser could not reach the API. Check network access, API-key permission, or the service CORS configuration.",
    testRequestFailed: "Request failed",
    testErrorNoTaskId: "The create response did not return a task ID.",
    testQueryingTask: "Querying task",
    testQueryFailed: "Query failed:",
    testSubmittingTask: "Submitting video creation request",
    testCreated: "Task created:",
    testCreateFailed: "Create failed:",
    testCompleted: "Task completed. Result URL received.",
    testCopyFailed: "The browser denied clipboard access. Copy the response manually.",
    devGuideTitle: "Method 2: Integrate in developer tools",
    devGuideLead:
      "Follow the official docs to configure integration, or copy the example above into your service and adjust it.",
    docs: "View Official Docs",
    createKeyTitle: "Create API Key",
    close: "Close",
    createTip: "ⓘ Tips",
    createTipItems: [
      "Do not expose API keys. Billing is based on API-key usage; see resource details for billing rules.",
      "For temporary use or scheduled rotation, create multiple API keys and manage them separately.",
      "If an API key leaks, reset it or delete the service.",
    ],
    keyName: "API Key Name",
    keyNamePlaceholder: "Use a clear name, for example: My Agent Tool",
    expireTime: "Expiration",
    neverExpires: "Never expires",
    permanent: "Permanent",
    cancel: "Cancel",
    confirm: "Confirm",
    keyNameError: "Enter an API key name with 1-20 characters.",
    requestFailed: "Request failed",
    keyCreatedMissing: "The API key was created, but the new key was not found in the list.",
    keyFetchFailed: "The API key was created, but its value could not be fetched.",
    keyCreated: "API key created. Copy and store it now.",
...
export const tagLabels = {
  ...
  工具调用: "Tool calling",
  稳定: "Stable",
  青焰推荐: "verdantflare pick",
  舞蹈生成: "Dance generation",
  动作一致: "Motion consistency",
  百万上下文: "Million-token context",
  工程任务: "Engineering tasks",
  多模态: "Multimodal",
  长任务: "Long tasks",
  文档: "Documents",
  视觉: "Vision",
  ...
  编程: "Programming",
  视频生成: "Video generation",
  主体一致: "Subject consistency",
  多镜头: "Multi-shot",
  旗舰: "Flagship",
  商业短片: "Commercial short",
  高质量: "High quality",
};

export const maxInputLabels = {
  "图文/动作": "Image/text/motion",
  图文: "Image/text",
};
...
export const tCategory = (value, locale) =>
  locale === "en" ? categoryLabels[value] || value : value;

export const tProvider = (value, locale) =>
  locale === "en" ? providerLabels[value] || value : value;

export const tTag = (value, locale) =>
